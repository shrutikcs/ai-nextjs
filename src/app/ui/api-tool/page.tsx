  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground px-4">
      ...
      <div className="flex-1 w-full max-w-2xl mx-auto pt-20 pb-40">
        <div className="flex flex-col gap-8">
          {messages.map((message) => (
            <div key={message.id} className="flex flex-col gap-1.5">
              <div
                className={`text-xs font-bold uppercase tracking-widest ${message.role === "user"
                    ...
                    case "tool-getWeather":
                      switch (part.state) {
                        ...
                        case "output-available":
                          return (
                            <div key={`${message.id}-getWeather-${index}`} className="my-2 min-w-[280px]">
        ...
        <div
          className={`flex flex-col ${messages.length === 0
